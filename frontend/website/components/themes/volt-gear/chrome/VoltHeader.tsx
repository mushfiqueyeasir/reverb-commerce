...
export interface VoltHeaderProps {
  categories: Category[];
...
export default function VoltHeader({
  ...
  return (
    <Suspense
      fallback={
        <div className="relative z-50 h-16 border-b border-border bg-background/80 backdrop-blur-xl md:sticky md:inset-x-0 md:top-0 md:h-20" />
      }
    >
      <VoltNavbar
