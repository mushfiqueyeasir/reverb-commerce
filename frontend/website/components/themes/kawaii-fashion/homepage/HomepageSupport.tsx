...
export function KawaiiFashionGuarantees({
  ...
  return (
    <div className="relative overflow-hidden bg-background px-4 pb-6 pt-3 sm:px-6 sm:pb-20 lg:px-10 lg:pb-28">
      <section
...
export function KawaiiFashionStudioNotes({
  ...
  return (
    <div className="relative overflow-hidden bg-background px-4 pb-6 pt-3 sm:px-6 sm:pb-20 sm:pt-5 lg:px-10 lg:pb-28">
