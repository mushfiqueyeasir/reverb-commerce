...
with section_defaults(id, type, title, subtitle, config, position) as (
  values
    (
      ...
      null::text,
      null::text,
      '{"accessible_label":"Shopping guarantees","items":[{"title":"Carefully packed","body":"Prepared with attention, from us to you."},{"title":"Secure checkout","body":"A simple and protected shopping experience."},{"title":"Here to help","body":"Friendly support before and after your order."}]}'::jsonb,
      1
    ),
    (
      '60000000-0000-4000-8000-000000000016'::uuid,
      'studio_notes'::text,
      'New edits, style stories, and lovely little surprises.'::text,
      'Join our list to hear about fresh arrivals and special collections.'::text,
